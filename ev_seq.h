...
#define EV_INT_STOP  1
#define EV_LOG_STOP  EV_INT_STOP  + 1
#define EV_INT_ZERO  EV_LOG_STOP  + 1
#define EV_INT_CAL   EV_INT_ZERO  + 1
#define EV_LOG_START EV_INT_CAL   + 1
#define EV_INT_START EV_LOG_START + 1
